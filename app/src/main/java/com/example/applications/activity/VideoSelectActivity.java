...
import com.example.applications.adapter.VideoSelectAdapter;
...
import com.example.applications.dialog.AlbumDialog;
import com.example.applications.manager.ThreadPoolManager;
import com.example.applications.other.GridSpaceDecoration;
    ...
    public void onChildClick(RecyclerView recyclerView, View childView, int position) {
        if (childView.getId() == R.id.fl_video_select_check) {
            ...
            if (!file.isFile()) {
                ...
                toast(getString(R.string.video_select_error));
                return;
            }
