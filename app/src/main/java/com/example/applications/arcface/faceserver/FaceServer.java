package com.example.applications.arcface.faceserver;
...
import com.example.applications.arcface.model.FaceRegisterInfo;
...
public class FaceServer {
    ...
    public int getFaceNumberByName(Context context,String uName) {
        synchronized (this) {
            if (context == null) {
                return 0;
            }
    ...
    public int clearFacesByName(Context context,String uName) {
        synchronized (this) {
            if (context == null) {
                return 0;
            }
