...
import com.example.applications.entity.BaseResponse;
...
//                vh.imgCollect.setImageResource(R.drawable.collect_select);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private ShineButton imgCollect;
        private ShineButton imgDizan;
        ...
        public ViewHolder(@NonNull View view) {
            ...
            tvDz = view.findViewById(R.id.like);
...
//                        imgCollect.setImageResource(R.drawable.collect_select);
                        imgCollect.setChecked(true);
...
//                            imgDizan.setImageResource(R.drawable.dianzan);
                            imgDizan.setChecked(false);
                            updateCount(mdatas.get(mPosition).getVid(), 2, !flagLike);
                        }
                    } else {//未点赞
                        tvDz.setText(String.valueOf(++likeNum));
                        tvDz.setTextColor(Color.parseColor("#E21918"));
//                        imgDizan.setImageResource(R.drawable.dianzan_select);
                        imgDizan.setChecked(true);
                        updateCount(mdatas.get(mPosition).getVid(), 2, !flagLike);
                    }
                    flagLike = !flagLike;
                }
